...
- bootstrap repeats: `0`
- start month: `0`
- target-mean overall EI 1..24: `0.576402` bits
...
- IOD: Pearson min `0.854`, Spearman min `0.245`, top-3 overlap min `2`。

## 图表与数据

- 逐 seed / target / lead 原始结果：`results/unicm_overall_ei_tm_degree1_n8192/overall_ei_rows.jsonl`
- target 鲁棒性汇总：`results/unicm_overall_ei_tm_degree1_n8192/overall_ei_seed_robustness_summary.csv`
- lead-level seed mean/std：`results/unicm_overall_ei_tm_degree1_n8192/overall_ei_seed_lead_summary.csv`
- 图：`results/unicm_overall_ei_tm_degree1_n8192/fig/overall_ei_seed_overlay.png`
